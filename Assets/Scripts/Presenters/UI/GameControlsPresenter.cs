...
namespace Solitaire.Presenters
{
    public class GameControlsPresenter : OrientationAwarePresenter
    {
        ...
        protected override void OnOrientationChanged(bool isLandscape)
        {
            ...
            _rectOptions.anchoredPosition = new Vector2(isLandscape ? -210 : -165, _rectOptions.anchoredPosition.y);
            _rectHome.anchoredPosition = new Vector2(isLandscape ? -70 : -55, _rectHome.anchoredPosition.y);
            ...
            _rectUndo.anchoredPosition = new Vector2(isLandscape ? 350 : 275, _rectUndo.anchoredPosition.y);
        }
    }
}